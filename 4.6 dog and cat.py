...
learning_rate = 0.001
data_dir = './dataset'
train_cats_dir = data_dir + '/training_data/cats/'
train_dogs_dir = data_dir + '/training_data/dogs/'
test_cats_dir = data_dir + '/testing_data/cats/'
test_dogs_dir = data_dir + '/testing_data/dogs/'
...
if __name__ == '__main__':
    ...
    train_labels = tf.concat([
        ...
        axis=-1)
    #加载数据tf.data.Dataset.from_tensor_slices
